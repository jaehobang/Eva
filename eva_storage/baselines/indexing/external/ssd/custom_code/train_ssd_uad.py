...
def normalize_boxes(all_boxes, image_width, image_height):
    """
    We don't need to normalize the boxes, it is already done in train augmentation
    Corner coordinates to center coordinates conversion is also done by MatchPriorModified augmentation
